...
<html>
    ...
    <body>
        <h1 align="center">Pickup Laundry Admin Registration</h1>
        <hr>
        <%			if (request.getAttribute("aRegErrors") != null) {
				List<String> errors = (List<String>) request.getAttribute("aRegErrors");
        %>
