...
<html>
    ...
    <body>
        <%
			...
			if (mobileNo.isEmpty() || username.isEmpty() || email.isEmpty() || city.isEmpty() || add.isEmpty() || pass.isEmpty() || conPass.isEmpty() || captcha.isEmpty()) {
			...
			if (!errors.isEmpty()) {
				request.setAttribute("aRegErrors", errors);
