...
<html>
    ...
    <body>
		<h1 align="center">Pickup Laundry Admin Login</h1>
		<hr>

		<%
			if (request.getAttribute("aLogErrors") != null) {
				List<String> errors = (List<String>) request.getAttribute("aLogErrors");
		%>
		...
		<%
			...
			for (Cookie cookie : cookies) {
				if ("aCkEmail".equals(cookie.getName())) {
					email = cookie.getValue();
				} else if ("aCkPass".equals(cookie.getName())) {
