...
<html>
    ...
    <body>
		...
		<div style="text-align: center;">
			...
			<a href="./ViewStaff.jsp">View Staff</a>&ensp;|
			<a href="../Logout.jsp">Logout</a>
		</div>
		<hr>

		<h1 align="center">Update Staff</h1>
		...
		<%
			...
			if (request.getParameter("mobileNo") != null) {
				...
				mobileNo = session.getAttribute("sesSMobileNo").toString();
			}
		...
		<form action="valUpdStaff.jsp" method="POST">
			...
			<div class="text-center">
				<p>Don't want to update? <a href="./ViewStaff.jsp">View Staff</a></p>
			</div>
		</form>
    </body>
</html>
